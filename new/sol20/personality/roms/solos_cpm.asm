; SOLOS with minor patches for CP/M
;
; This source includes the following patches: 
;   1) Jump to E900 (single density NorthStar boot ROM) when the
;      LOAD button is pressed.
;   2) Don't erase to EOL when CR pressed. This keeps CP/M 1.4
;      from erasing the line just typed when C/R pressed.
;
;
